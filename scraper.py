...
def get_stealth_session() -> requests.Session:
    """توليد جلسة مموهة تبدو كـ Chrome 124 حقيقي وموجهة عبر شبكة Tor لتغيير الـ IP"""
...
# ================================
# محرك الكشط والتفتيش المخصص
# ================================
class GameScraperEngine:
    def __init__(self, game_input: Union[str, Dict[str, Any]]):
        # استخراج اسم اللعبة سواء كان العنصر نصاً مباشراً أو Dictionary
...
def main():
    ...
    try:
        ...
        # استخراج القائمة سواء كانت مصفوفة مباشرة أو داخل مفتاح "games"
