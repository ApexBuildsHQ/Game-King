...
# إيقاف أشرطة التقدم لـ CLI و SDK لمنع ثقل السجلات ومنع أخطاء الاستيراد
...
def process():
    ...
    for game in games:
        ...
        try:
            ...
            # 5. الرفع باستخدام CLI المخصص للملفات الضخمة لمنع التوقف وقطع الاتصال
            upload_cmd = (
                f"huggingface-cli upload {HF_REPO} '{obfuscated_filename}' 'bins/{obfuscated_filename}' "
